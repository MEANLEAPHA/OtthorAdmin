    ...
    return(
        ...
        <section>
             <article className='article-header'>
                <FontAwesomeIcon icon={faChevronRight} style={{fontSize:'small'}}/> <label onClick={()=>{navigate('/FeedbackAndReport')}} className='link-page'>Feedback and Report</label> / <label onClick={()=>{navigate('/Feedback')}} className='link-page'>Feedback</label>
            </article>
        </section> 
        </>
    )
