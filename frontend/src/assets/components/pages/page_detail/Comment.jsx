    ...
    return(
        ...
        <section>
             <article className='article-header'>
                <FontAwesomeIcon icon={faChevronRight} style={{fontSize:'small'}}/> <label onClick={()=>{navigate('/UserInsight')}} className='link-page'>User Insight</label> / <label onClick={()=>{navigate('/Comment')}} className='link-page'>Comment</label>
            </article>
        </section> 
        </>
    )
